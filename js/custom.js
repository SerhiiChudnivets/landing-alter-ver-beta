   ...
   var email = document.getElementById('email').value;
    ...
    if ( !name || !email) {
        ...
        if  ( pattern.test(name) && pattern_mail.test(email)) {
            ...
            console.log('cars=',check_cars.value);
            console.log('rent=',check_rent.value);
            console.log('metall=',check_property.value);
            console.log('other=',check_other.value);
            
            
            $('#answer').text('Ви успішно підписались на новини');
